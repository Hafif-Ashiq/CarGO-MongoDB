...
public class ListProducts {
    ...
    // Side Buttons
    private Button Stats, Products, Modify, Back;
    ...
    public ListProducts(int width, int height, String title, String location, String CarText, String Name) {
        ...
        // Adding TypeText
        Text TypeText = new Text(this.frame, 350, 30, 300, 100, CarText, "C:\\Users\\Abdullah\\Desktop\\DB Mongo\\src\\main\\Fonts\\Montserrat-Bold.ttf", 40f);
        ...
        try {
            ...
            for (Document doc : Static.db.getCollection("Jeep").find(filter).projection(projection)){
                ...
                int price = Integer.parseInt(doc.toJson().split(",")[5].split(":")[1].substring(1));
                String picture_name = doc.toJson().split(",")[6].split(":")[1].split("\"")[1];
                String pic_address = doc.toJson().split(",")[7].split(":")[1].split("\"")[1];
                String picture_address = pic_address.substring(21,pic_address.length()-1);
        ...
        if (array.size() == 0){
            Text sorry = new Text(this.frame, 670, 350, 250, 40, "No Products Exist!", "C:\\Users\\Abdullah\\Desktop\\DB Mongo\\src\\main\\Fonts\\Montserrat-SemiBold.ttf", 25f);
