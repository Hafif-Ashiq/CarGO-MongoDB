...
public class Company_HomeScreen {
    ...
    public Company_HomeScreen(int width, int height, String title, String location, String text, String Name) {
        ...
        Text stats = new Text(this.frame, 350, 30, 300, 100, "Statistics", "C:\\Users\\Abdullah\\Desktop\\DB Mongo\\src\\main\\Fonts\\Montserrat-Bold.ttf", 40f);
        ...
        new Text(this.frame, 30, 26, 140, 60, "Welcome,", "C:\\Users\\Abdullah\\Desktop\\DB Mongo\\src\\main\\Fonts\\Montserrat-SemiBold.ttf", 18f);
        new Text(this.frame, 30, 55, 180, 60, Name, "C:\\Users\\Abdullah\\Desktop\\DB Mongo\\src\\main\\Fonts\\Montserrat-Bold.ttf", 30f);

        // Add Company Picture
        Pic = new Button(false);
        frame.add(Pic.newButton(230, 42, 60, 60, "+", "C:\\Users\\Abdullah\\Desktop\\DB Mongo\\src\\main\\Fonts\\Montserrat-Regular.ttf", 45f));
        ...
        frame.add(Modify.newButton(0, start*3+3, 300, 144, "Modify", "C:\\Users\\Abdullah\\Desktop\\DB Mongo\\src\\main\\Fonts\\Montserrat-Bold.ttf", 20f));
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("select car.price,car.car_id,car.name,booking.booking_date from (booking natural join car) cross join stats where company = '" + Static.current_user + "' and booking.id = stats.booking_id and car.car_id = booking.car");
...
//
        ...
        // 1140, 580, 70, 70
        new TextPanel(frame, 1140, 580, 70, 70,"$", "C:\\Users\\Abdullah\\Desktop\\DB Mongo\\src\\main\\Fonts\\Montserrat-SemiBold.ttf", 48f);
        TextPanel total_price = new TextPanel(frame, 780, 580, 360, 70,"+ $" + t_price, "C:\\Users\\Abdullah\\Desktop\\DB Mongo\\src\\main\\Fonts\\Montserrat-Bold.ttf", 48);
